python3 main.py --reset --datadir ../dataset/data_PRCV2020/ --batchid 8 --batchtest 32 --test_every 5 --epochs 10 --decay_type step_2_6 --loss 1*CrossEntropy+2*Triplet --margin 0.3 --re_rank --random_erasing --save MGN_test --cpu  --lr 2e-4 --optimizer ADAM --load MGN_adam



# python3 main.py --reset --datadir ../dataset/data_PRCV2020/ --batchid 8 --batchtest 32 --test_every 40 --epochs 200 --decay_type step_120_160 --loss 1*CrossEntropy+2*Triplet --margin 0.3 --re_rank --random_erasing --save MGN_test --cpu  --lr 2e-4 --optimizer ADAM
